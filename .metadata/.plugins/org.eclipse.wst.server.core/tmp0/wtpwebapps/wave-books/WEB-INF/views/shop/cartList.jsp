				   ...
				   <div class="orderOpne">
				    	...
				    	<script>
						 ...
						 $(document).ready(function(){
							 ...
							 $(".chBox").each((index,chbox)=>{
						    		$(chbox).on("change",function(){
						    			//체크되었을때 실행문
						    			let sumprice = 0;
						    			$(".chBox").each((index,chbox2)=>{
				
						    				if($(chbox2).prop("checked")){
							    				sumprice += $(chbox2).data("cartprice");					    				
							    			}
							    			
						    			})
						    			$(".sum").text("총합계 : " + sumprice + " 원");
						        ...
						        new daum.Postcode({
						            oncomplete: function(data) {
						                ...
						                if(data.userSelectedType === 'R'){
						                    ...
						                    document.getElementById("sample2_extraAddress").value = '동없음';
						                }
