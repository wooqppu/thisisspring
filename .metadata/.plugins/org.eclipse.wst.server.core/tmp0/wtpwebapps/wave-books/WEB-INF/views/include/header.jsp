<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<header class="py-5 bg-image-full" style="background-image: url('/resources/images/img4.jpg'); width:2000px, 1000px;" >
		<div class="text-center my-5">
            <img class="img-fluid rounded-circle mb-4" src="/resources/images/logo4.JPG" style="width:270px;" alt="..." />
