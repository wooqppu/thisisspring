...
<style>
	...
	ul.orderView li { display: flex; align-items: center; padding-bottom: 20px;  } 
 	...
 	div.deliveryChange button { background:#fff; border: 1px solid #4e73df; color: #4e73df; }
	 div.deliveryChange button:hover { background: #4e73df; border:1px solid #4e73df; color: #fff; }
 	
 	.delivery1_btn { margin-right: 20px; }
